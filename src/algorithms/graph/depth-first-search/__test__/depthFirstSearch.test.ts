...
//     deepEqual(enterVertexCallback).toHaveBeenCalledTimes(graph.getAllVertices().length);
//     deepEqual(leaveVertexCallback).toHaveBeenCalledTimes(graph.getAllVertices().length);
...
//     deepEqual(enterVertexCallback).toHaveBeenCalledTimes(7);
//     deepEqual(leaveVertexCallback).toHaveBeenCalledTimes(7);
