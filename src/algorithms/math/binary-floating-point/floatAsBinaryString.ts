 ...
 *
 * @param floatNumber float number in decimal format.
 * @param byteLength number of bytes to use to store the float number.
 * @return binary string representation of the float number.
 */
 ...
 *
 * @param floatNumber float number in decimal format.
 * @return 64 bits binary string representation of the float number.
 */
export function floatAs64BinaryString(floatNumber: number): string
{
 ...
 *
 * @param floatNumber float number in decimal format.
 * @return 32 bits binary string representation of the float number.
 */
export function floatAs32BinaryString(floatNumber: number): string
{
